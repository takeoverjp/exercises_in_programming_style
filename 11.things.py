...
class StopWordManager(TFExercise):
    ...
    def info(self):
        return super().info() + ": My major data structure is a " + self._stop_words.__class__.__name__
...
class WordFrequencyManager(TFExercise):
    ...
    def info(self):
        return super().info() + ": My major data structure is a " + self._word_freqs.__class__.__name__
